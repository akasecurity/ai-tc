...
//
// No color anywhere — the surfaces are echoed verbatim into the Antigravity CLI
...
// of throwing, so a store fault never breaks the Antigravity session. This is the
...
export const STORE_UNAVAILABLE_NOTE =
  "I couldn't check my records just now — we can check again soon. Your Antigravity session keeps going, and I'll fill in as you work.";
...
// One line for a statusLine-style persistent footer, if/when Antigravity CLI exposes
...
export function buildHealthReport(
  ...
  return {
    title: 'Setup health — local Antigravity CLI deployment',
    gauges,
