...
//
// NO COLOR on the read surfaces. They are echoed verbatim into the Antigravity
...
// Antigravity CLI exposes an equivalent ANSI-interpreting status surface — never
