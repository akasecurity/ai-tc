...
//
// The peer of plugins/claude-code/test/e2e/session-start-brief.e2e.test.ts.
// This plugin never MINTS a pointer (see pre-tool-use-decision.ts), but
// `vaultConsent` is a workspace-wide grant recorded in the one shared
