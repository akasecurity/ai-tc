 ...
 * human-facing copy "I went through Antigravity's recent work — N detections, M
...
export function frameCalibration(
  ...
  const headline =
    `I went through Antigravity's recent work — ${String(total)} detection${total === 1 ? '' : 's'}, ` +
...
const SCAN_CLEAN_HEADLINE =
  "I looked over Antigravity's recent work — nothing needs your attention right now. " +
...
const NO_HISTORY_HEADLINE =
  "Nothing to learn from yet — Antigravity hasn't left any work on this machine. " +
