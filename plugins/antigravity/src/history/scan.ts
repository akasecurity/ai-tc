...
// their prior Antigravity CLI rollout files for secrets that leaked BEFORE AKA was
// installed (the live hooks cover everything after). Format-agnostic — the
// Antigravity rollout shape lives in ./transcripts; here we just feed each message
