...
describe('SecretVault', () => {
  // The shared harness owns the temp store: `open`/`openRaw` hand out handles it
  // closes at teardown, so a forgotten close cannot leave the tree undeletable
  // on Windows. Rolling this by hand is what leaked a migration handle here.
