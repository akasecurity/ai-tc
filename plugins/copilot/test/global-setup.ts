...
// Builds the plugin's scripts/*.js once before the suite runs. The e2e suites
// spawn those built scripts; Vitest runs globalSetup in the main process to
// completion before any test worker starts, so the build finishes before any
