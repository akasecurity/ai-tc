...
// plugins/codex/tsup.config.ts and plugins/claude-code/tsup.config.ts — all
// three bundle @akasecurity/persistence, which imports node:sqlite.
//
...
export default defineConfig({
  ...
  onSuccess: async () => {
    ...
    // Claude Code and Codex plugin builds copy the same asset).
    copyFileSync(
