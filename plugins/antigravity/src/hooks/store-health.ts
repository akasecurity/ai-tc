...
/**
 * Gate the store-unavailable warning to once per Antigravity session instead
 ...
 * object written beside the decision would not parse — either way the tool call
 * is blocked. stderr carries no such contract.
 *
