...
![Coming soon](https://img.shields.io/badge/Coming_soon-00E0B8?style=flat-square&labelColor=232F3E)
...
> **Coming soon.** The code isn't public here yet; the release is close. This README is what ships with it. [Watch this repo](https://github.com/akasecurity/ai-tc) to hear when the code lands, and read the [docs](https://akasecurity.github.io/ai-tc-docs/) in the meantime.
...
*Coming with the release.* When `ai-tc` ships, it installs as a plugin through the AKA marketplace. In Claude Code:
...
Open source and local-first, with an enterprise edition on the way.

---

From [akasecurity.io](https://akasecurity.io). Licensing announced with the release.
