 ...
 * (`loadConfig(undefined, resolveCodexProvider)`) rather than through
 * `handleSessionStart`'s default, which resolves the wrong provider shape for
 * this host — see the comment at that call site.
 *
