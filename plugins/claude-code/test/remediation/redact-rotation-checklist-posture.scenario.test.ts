...
describeShimmed(
  "'Redact + rotation checklist' through the built remediate.js persists the standing posture",
  () => {
...
describeShimmed(
  "'Redact + rotation checklist' through the built remediate.js: the per-transcript count is independent of the redacted-key count",
  () => {
    let journey: SetupJourney;
