  ...
  try {
    for (const rule of rules) {
      ...
      if (prober) {
        ...
        // there is, and the only breach that needs no corroboration: the pattern
        // did not merely spend a budget, it never came back, and no stall makes a
        // thread refuse to finish. Persist it.
